...
void solve(){
    ...
    bool yopp = (y1>y2 && y1<y3)||(y1<y2 && y1>y3), 
         xopp = (x1>x2 && x1<x3)||(x1<x2 && x1>x3), 
         xsame= (x1>x2 && x1>x3)||(x1<x2 && x1<x3), 
         ysame= (y1>y2 && y1>y3)||(y1<y2 && y1<y3);
    if(yopp && xopp) cout << "1\n";
    else if(yopp){
        if(x1==x2 && x1==x3) cout << "1\n";
        else cout << min(abs(x1-x2), abs(x1-x3))+1 << '\n';   
    }
    else if(xopp){
        if(y1==y2 && y1==y3) cout << "1\n";
        else cout << min(abs(y1-y2), abs(y1-y3))+1 << '\n';
    }
    else{
        cout << min(abs(y1-y2), abs(y1-y3))+min(abs(x1-x2), abs(x1-x3))+1 << '\n';
    }
}